...
Last updated 2014-02-26 22:38:56 using R version 3.0.2 (2013-09-25).
...
```
## Reading routes run from 2013-01-01 to 2014-02-26
```
...
```
## Error: XML content does not seem to be XML: 'Data/user001/NA'
```
...
```
## Error: arguments imply differing number of rows: 132, 0
```
